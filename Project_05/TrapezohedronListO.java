...
public class TrapezohedronListO {
   ...
   */
   public TrapezohedronListO(String lNameIn, ArrayList<Trapezohedron> tObjsIn) {
   ...
   * of trapezohedrons.
   * @return averageTotal - average surface area
   */
   ...
   * of trapezohedrons.
   * @return averageTotal - average volume
   */
